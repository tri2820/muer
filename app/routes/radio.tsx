...
export default function RadioPage() {
    ...
    return <div className="p-6 pt-16">
        ...
        {
            playingVideoData?.recommendedVideos ? <div className="space-y-8">
                ...
                <tr 
                        ...
                        className="group/row cursor-pointer transition-all duration-150 ">
                                        <td className="w-16 pl-6 group-hover/row:bg-white/8 rounded-l-lg text-neutral-400">
                                            <span className="group-hover/row:hidden">{1}</span>
                                            <span className="hidden group-hover/row:block text-white">{
                                                <PlayIcon className="w-4 h-4"/>
                                            }</span>
                                        </td>
                                        <td className="p-3 pr-6 group-hover/row:bg-white/8 rounded-r-lg"><VideoListThumbnail video={{
        ...
        <div className="space-y-2">
            ...
            <tbody>
                ...
                {
                    playingVideoData.recommendedVideos.map((x: any, i: number) => {
